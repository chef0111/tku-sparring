...
- reading `props.children` records â€œthere will be children hereâ€
- calling `props.renderSomething(args)` records â€œcall this slot with these args laterâ€
- reading a component prop like `props.AddToCart` records â€œrender this client component here with these props laterâ€
