...
The fastest way to get TanStack Start RSC wrong is to think â€œloader = serverâ€.
...
That makes it the replacement for â€œI need server-rendered markup here, but I still need client interactivity in the middle of it.â€
...
- Next â€œserver-first treeâ€ -> Start â€œisomorphic-first app with opt-in RSC fragmentsâ€
