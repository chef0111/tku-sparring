  ...
  return (
    ...
    >
      ...
      {keyLabel && (
        <span
          className={cn(
            'absolute -bottom-7.5 flex -translate-y-8 items-center justify-center rounded-full p-1 text-center text-lg leading-1.75 font-bold text-[#a6a6a6] select-none max-xl:p-0.75 max-xl:text-base max-xl:leading-1.5',
            player === 'red'
              ? 'text-muted-foreground bg-[#ff0000]'
              : 'text-muted-foreground bg-[#0089fd]'
          )}
        >
          {keyLabel}
        </span>
